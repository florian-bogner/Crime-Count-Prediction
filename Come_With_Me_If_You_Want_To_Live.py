...
with st.sidebar:
    input_boro = st.selectbox('Select NYC borough:', ('Manhattan', 'Bronx', 'Queens', 'Brooklyn', 'Staten Island'))
    ...
    input_ethn = st.selectbox(
         'Select ethnicity:', ('Black', 'White', 'White Hispanic', 'Asian/Pacific Islander', 'Black Hispanic', 'American Indian/Alaskan Native'))
